...
MathJax.Hub.Register.StartupHook("TeX Jax Ready",function () {
  ...
  TEX.Parse.Augment({
    //
    //  Implements \FormInput[size][class][readonly][value][data_name][data_value]{name}
    //
    FormInput: function (name) {
      var size = this.GetBrackets(name),
          ...
          data_name = this.GetBrackets(name),
          data_value = this.GetBrackets(name),
      ...
      if(data_name != null && data_value != null) {
        input.setAttribute("data-"+data_name,data_value);
      }
